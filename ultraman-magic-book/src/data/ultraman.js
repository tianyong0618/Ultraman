export const ultramanData = [
  ...
  { id: 5, name: '泰罗奥特曼', year: 1973, series: '泰罗奥特曼', era: '昭和时期', desc: '奥特之父与奥特之母的亲生儿子，奥特兄弟第六位成员。拥有奥特兄弟中最强的战斗能力，可以使用奥特炸弹，是宇宙警备队首席教官，泰迦奥特曼的父亲。', forms: [
    ...
    { name: '超级形态', image: '/images/ultraman/06_泰罗_超级形态.jpg', skills: ['斯特利姆光线'] },
    { name: '少年形态', image: '/images/ultraman/06_泰罗_少年形态.jpg', skills: ['泰罗手镯'] }
  ...
  { id: 11, name: '迪迦奥特曼', year: 1996, series: '迪迦奥特曼', era: '平成时期', desc: '奥特曼30周年纪念作，开启平成时代。3000万年前超古代黑暗巨人，后受幽怜感召弃暗投明。与卡蜜拉、达拉姆、希特拉三大黑暗巨人决战获胜后获得三种形态。', forms: [
    ...
    { name: '强力型', image: '/images/ultraman/13_迪迦_强力型.jpg', skills: ['迪迦拉休尔光流'] },
    { name: '闪耀型', image: '/images/ultraman/13_迪迦_闪耀型.jpg', skills: ['迪迦计时器闪光'] }
  ...
  { id: 12, name: '戴拿奥特曼', year: 1997, series: '戴拿奥特曼', era: '平成时期', desc: '迪迦的续作，来自宇宙的神秘之光。与宇宙飞行员飞鸟信合为一体。具有和迪迦相似却更极端的三形态转换能力。', forms: [
    { name: '闪亮型', image: '/images/ultraman/14_戴拿.jpg', skills: ['索尔捷特光线'] },
    { name: '奇迹型', image: '/images/ultraman/14_戴拿_奇迹型.jpg', skills: ['立波留姆光弹'] },
    { name: '强壮型', image: '/images/ultraman/14_戴拿_强壮型.jpg', skills: ['强壮重击'] }
  ], skills: ['索尔捷特光线', '立波留姆光弹', '强壮重击'], catchphrase: '戴拿！', human: '飞鸟信', color: '#00BFFF', image: '/images/ultraman/14_戴拿.jpg' },
  { id: 13, name: '盖亚奥特曼', year: 1998, series: '盖亚奥特曼', era: '平成时期', desc: '平成时期代表作品。盖亚是地球本身产生的光之巨人，与阿古茹形成双主角设定。代表大地的力量。', forms: [
    { name: 'V2型', image: '/images/ultraman/15_盖亚.jpg', skills: ['量子冲击'] },
    { name: 'V3型', image: '/images/ultraman/15_盖亚_V3型.jpg', skills: [] },
  ...
  { id: 15, name: '奈克瑟斯奥特曼', year: 2004, series: '奈克瑟斯奥特曼', era: '平成时期', desc: '风格较黑暗的成人向作品。系列构成新颖，采用单元剧形式。是被诺亚奥特曼选中的适能者。', forms: [
    ...
    { name: '蓝色成年型', image: '/images/ultraman/17_奈克瑟斯_蓝色成年型.jpg', skills: ['十字风暴'] },
    { name: '红色成年型', image: '/images/ultraman/17_奈克瑟斯_红色成年型.jpg', skills: ['奈克瑟斯光线'] },
    { name: '诺亚形态', image: '/images/ultraman/17_奈克瑟斯_诺亚形态.jpg', skills: ['诺亚闪电'] }
  ], skills: ['奈克瑟斯光线', '十字风暴', '诺亚闪电'], catchphrase: 'Nexus！', human: '姬矢准（第一适能者）、千树怜、孤门一辉', color: '#4B0082', image: '/images/ultraman/17_奈克瑟斯.jpg' },
  ...
  { id: 17, name: '梦比优斯奥特曼', year: 2006, series: '梦比优斯奥特曼', era: '平成时期', desc: '奥特曼40周年纪念作。来到地球后加入GUYS队，是昭和奥特的集大成之作。', forms: [
    { name: '普通形态', image: '/images/ultraman/19_梦比优斯.jpg', skills: ['梦比优斯光线'] },
    { name: '无限形态', image: '/images/ultraman/19_梦比优斯_无限形态.jpg', skills: ['梦比优斯光线'] },
    { name: '凤凰形态', image: '/images/ultraman/19_梦比优斯_凤凰形态.jpg', skills: ['梦比优斯爆裂', '扎古光线'] }
  ], skills: ['梦比优斯光线', '梦比优斯爆裂', '扎古光线'], catchphrase: '梦比优斯！', human: '日比野未来', color: '#FF4500', image: '/images/ultraman/19_梦比优斯.jpg' },
  ...
  { id: 20, name: '艾克斯奥特曼', year: 2015, series: '艾克斯奥特曼', era: '新生代', desc: '融合数码科技元素的奥特战士。可以将怪兽卡片实体化进行战斗。', forms: [
    { name: '基础形态', image: '/images/ultraman/22_艾克斯.jpg', skills: ['艾克斯射线'] },
    { name: '虚拟哥莫拉', image: '/images/ultraman/22_艾克斯_虚拟哥莫拉.jpg', skills: ['哥莫拉冲击', '虚拟哥莫拉装甲'] },
    { name: '超越哥莫拉', image: '/images/ultraman/22_艾克斯_超越哥莫拉.jpg', skills: [] }
  ], skills: ['艾克斯射线', '哥莫拉冲击', '虚拟哥莫拉装甲'], catchphrase: '艾克斯！', human: '大空大地', color: '#00FF7F', image: '/images/ultraman/22_艾克斯.jpg' },
  { id: 21, name: '欧布奥特曼', year: 2016, series: '欧布奥特曼', era: '新生代', desc: '可使用前辈力量的融合战士。欧布之意是O（起源）+β（融合）。通过读取卡片融合前辈力量变身。', forms: [
    { name: '起源形态', image: '/images/ultraman/23_欧布.jpg', skills: ['欧布高贾'] },
    { name: '暴怒形态', image: '/images/ultraman/23_欧布_暴怒形态.jpg', skills: [] },
    { name: '疾风形态', image: '/images/ultraman/23_欧布_疾风形态.jpg', skills: [] },
    { name: '暗耀形态', image: '/images/ultraman/23_欧布_暗耀形态.jpg', skills: ['Z修姆加农'] },
    { name: '辉煌形态', image: '/images/ultraman/23_欧布_辉煌形态.jpg', skills: ['Z修姆光轮'] }
  ], skills: ['欧布高贾', 'Z修姆光轮', 'Z修姆加农'], catchphrase: '欧布！', human: '红凯', color: '#FF1493', image: '/images/ultraman/23_欧布.jpg' },
  { id: 22, name: '捷德奥特曼', year: 2017, series: '捷德奥特曼', era: '新生代', desc: '贝利亚之子。为证明自己不是贝利亚而战斗。使用贝利亚的胶囊提取力量。', forms: [
    { name: '初始形态', image: '/images/ultraman/24_捷德.jpg', skills: [] },
    { name: '刚燃形态', image: '/images/ultraman/24_捷德_刚燃形态.jpg', skills: ['毁灭拳击'] },
    { name: '机敏形态', image: '/images/ultraman/24_捷德_机敏形态.jpg', skills: [] },
    { name: '尊捷形态', image: '/images/ultraman/24_捷德_尊捷形态.jpg', skills: ['尊捷光轮'] },
    { name: '终极形态', image: '/images/ultraman/24_捷德_终极形态.jpg', skills: ['捷德毁灭光线'] }
  ], skills: ['捷德毁灭光线', '毁灭拳击', '尊捷光轮'], catchphrase: '捷德！', human: '朝仓陆', color: '#DC143C', image: '/images/ultraman/24_捷德.jpg' },
  { id: 23, name: '罗布奥特曼', year: 2018, series: '罗布奥特曼', era: '新生代', desc: '兄弟二人变身的奥特战士。活海和勇海兄弟。与妹妹凑朝阳共同作战。', forms: [
    { name: '罗索形态', image: '/images/ultraman/25_罗布.jpg', skills: ['罗布光轮'] },
    { name: '布鲁形态', image: '/images/ultraman/25_罗布_布鲁形态.jpg', skills: [] },
    { name: '格罗布形态', image: '/images/ultraman/25_罗布_格罗布形态.jpg', skills: ['格罗布漩涡', '火焰波浪'] }
  ], skills: ['罗布光轮', '格罗布漩涡', '火焰波浪'], catchphrase: '罗布！', human: '凑活海、凑勇海', color: '#FF6347', image: '/images/ultraman/25_罗布.jpg' },
  { id: 24, name: '泰迦奥特曼', year: 2019, series: '泰迦奥特曼', era: '新生代', desc: '泰罗之子，令和时代首作。 inherits 父亲的奥特炸弹。使用泰迦火花变身。', forms: [
    { name: '光之绊形态', image: '/images/ultraman/26_泰迦.jpg', skills: ['泰迦螺旋冲击'] },
    { name: '泰塔斯形态', image: '/images/ultraman/26_泰迦_泰塔斯形态.jpg', skills: [] },
    { name: '风马形态', image: '/images/ultraman/26_泰迦_风马形态.jpg', skills: [] },
    { name: '煜形态', image: '/images/ultraman/26_泰迦_煜形态.jpg', skills: ['光之芒', '奥特炸弹'] }
  ], skills: ['泰迦螺旋冲击', '光之芒', '奥特炸弹'], catchphrase: '泰迦！', human: '泰迦（泰罗之子）、工藤优幸', color: '#FF8C00', image: '/images/ultraman/26_泰迦.jpg' },
  { id: 25, name: '泽塔奥特曼', year: 2020, series: '泽塔奥特曼', era: '新生代', desc: '赛罗的弟子。使用泽塔升华器，读取勋章变形。使用阿尔法、贝塔、伽马三种形态。', forms: [
    { name: '阿尔法形态', image: '/images/ultraman/27_泽塔.jpg', skills: ['阿尔法爆碎'] },
    { name: '贝塔形态', image: '/images/ultraman/27_泽塔_贝塔形态.jpg', skills: ['贝塔粉碎击'] },
    { name: '伽马形态', image: '/images/ultraman/27_泽塔_伽马形态.jpg', skills: [] },
    { name: '德尔塔形态', image: '/images/ultraman/27_泽塔_德尔塔形态.jpg', skills: ['泽斯蒂姆光线'] }
  ], skills: ['泽斯蒂姆光线', '阿尔法爆碎', '贝塔粉碎击'], catchphrase: '泽塔！', human: '夏川遥辉', color: '#1E90FF', image: '/images/ultraman/27_泽塔.jpg' },
  { id: 26, name: '特利迦奥特曼', year: 2021, series: '特利迦奥特曼', era: '新生代', desc: '迪迦精神续作。汲取平成三杰的力量，是特利迦、戴拿、盖亚的融合。被称为新时代迪迦。', forms: [
    { name: '复合形态', image: '/images/ultraman/28_特利迦.jpg', skills: ['哉拉修尔光线'] },
    { name: '强力形态', image: '/images/ultraman/28_特利迦_强力形态.jpg', skills: ['迪拉修尔光流'] },
    { name: '空中形态', image: '/images/ultraman/28_特利迦_空中形态.jpg', skills: [] },
    { name: '永恒核心形态', image: '/images/ultraman/28_特利迦_永恒核心形态.jpg', skills: ['特利迦螺旋'] }
  ], skills: ['特利迦螺旋', '哉拉修尔光线', '迪拉修尔光流'], catchphrase: '特利迦！', human: '真中剑悟', color: '#FFD700', image: '/images/ultraman/28_特利迦.jpg' },
  { id: 27, name: '德凯奥特曼', year: 2022, series: '德凯奥特曼', era: '新生代', desc: '特利迦续作。被称为令和版戴拿。使用闪烁密钥变形。', forms: [
    { name: '闪亮形态', image: '/images/ultraman/29_德凯.jpg', skills: ['德凯闪亮光线'] },
    { name: '强劲形态', image: '/images/ultraman/29_德凯_强劲形态.jpg', skills: ['德凯冲击'] },
    { name: '奇迹形态', image: '/images/ultraman/29_德凯_奇迹形态.jpg', skills: ['奇迹光束'] },
    { name: '光辉形态', image: '/images/ultraman/29_德凯_光辉形态.jpg', skills: ['德凯闪亮光线'] }
  ], skills: ['德凯闪亮光线', '德凯冲击', '奇迹光束'], catchphrase: '德凯！', human: '龙门神藏（直接适能者）', color: '#00CED1', image: '/images/ultraman/29_德凯.jpg' },
  { id: 28, name: '布莱泽奥特曼', year: 2023, series: '布莱泽奥特曼', era: '新生代', desc: '原始野性风格的新作。贴近自然的战斗方式，使用布莱泽之弓作战。', forms: [
    { name: '通常形态', image: '/images/ultraman/30_布莱泽.jpg', skills: ['布莱泽脉冲', '布莱泽之弓'] },
    { name: '甲胄形态', image: '/images/ultraman/30_布莱泽_甲胄形态.jpg', skills: ['阿基托斯'] }
  ], skills: ['布莱泽脉冲', '布莱泽之弓', '阿基托斯'], catchphrase: '布莱泽！', human: '菱川见川（直接适能者）', color: '#228B22', image: '/images/ultraman/30_布莱泽.jpg' },
  { id: 29, name: '亚刻奥特曼', year: 2024, series: '亚刻奥特曼', era: '新生代', desc: '最新作品。亚刻源自日语「明るい」（明亮）。新时代的英雄。', forms: [
    { name: '通常形态', image: '/images/ultraman/31_亚刻.jpg', skills: ['亚刻光线', '亚刻飞踢'] },
    { name: '赛亚古形态', image: '/images/ultraman/31_亚刻_赛亚古形态.jpg', skills: [] }
